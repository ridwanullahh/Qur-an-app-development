...
const mockProgress = {
  ...
  memorizedSurahs: [1, 112, 113, 114, 105, 106, 107, 108, 109, 110, 111],
  inProgressSurahs: [2],
}
...
export default function MemorizationDashboard() {
  ...
  const progressPercentage = (mockProgress.totalVersesMemorized / mockProgress.totalVerses) * 100
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            مراجعة ({mockProgress.dueForReview})
          </Button>
          <Button
            onClick={() => {
              setSessionType("new")
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold">{mockProgress.totalVersesMemorized}</p>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold">{mockProgress.todayMinutes}</p>
